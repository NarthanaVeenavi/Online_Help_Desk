...
<body>
		...
		<form action="update" method="post" style="margin-top: -20cm;">
				...
				<tr>
					...
					<td>
						<select name="specialization" required>
							<option value="" selected disabled>Please select your specialization</option>
			...
			<input style="margin-left: 20cm; margin-top: 1cm; cursor: pointer; width: 5cm; height: 1cm; border-color: blue;" type="submit" name="submit" value="Update My Details"> 
		</form>
</body>
</html>